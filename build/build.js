...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueAuthenticate = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"vue-authenticate\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _vueAuthenticate2 = _interopRequireDefault(_vueAuthenticate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_vue2.default.use(_vueResource2.default);
	_vue2.default.use(_vueAuthenticate2.default, {
	...
	var apiURL = "http://localhost:7071/api/c/TESTTEST";
	  ...
	  methods: {
	    fetchFromServer: function fetchFromServer() {
	      ...
	      xhr.onload = function () {
	        ...
	        console.log(xhr.responseText.slice(0, 100));
	        console.log(self.model.id);
	      };
	      xhr.send();
	    },
	    sendToServer: function sendToServer() {
	      var xhr = new XMLHttpRequest();
	      var self = this;
	      xhr.open('POST', apiURL, /*async*/true);
	      var data = (0, _stringify2.default)(this.assessment);
	      xhr.send(data);
	    },
	    saveAnswer: function saveAnswer(question, option) {
	      var found = false;
	    ...
	    isAnswer: function isAnswer(question, option) {
	      var found = false;

	      this.assessment.Answers.forEach(function (a) {
	        if (a.id.valueOf() == question.id.valueOf() && a.answer.valueOf() == option.number.valueOf()) {
	          found = true;
	        }
	      });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(9)(_);
	    Vue.http = __webpack_require__(10)(_);
	    Vue.resource = __webpack_require__(14)(_);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jsonp = __webpack_require__(13);
